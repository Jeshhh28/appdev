...
import { LayoutDashboard, Users, Dumbbell, Pill, MessageSquare, BarChart3, Settings, LogOut, Heart } from "lucide-react"
      ...
      <div className="p-6 border-b border-[hsl(var(--sidebar-border))]">
        <div className="flex items-center space-x-2">
          ...
          <div>
            ...
            <p className="text-sm text-gray-300">Doctor Portal</p>
          </div>
        </div>
      </div>
